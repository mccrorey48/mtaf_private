...
if __name__ == '__main__':
    ...
    try:
        ...
        parser.add_argument("-d", "--db_name", type=str, default='ppo_results', help="name of db")
        parser.add_argument("-c", "--test_class", type=str, default='regression',
                            help="class of test, e.g. regression, smoke etc.")
        parser.add_argument("-e", "--environment", type=str, default='practice', help="environment e.g. practice")
        parser.add_argument("-f", "--features_directory", type=str, default='ppo/features',
        ...
        report_configuration = "site_tag:%s, run_tags:%s" % (site_tag, args.run_tags)
