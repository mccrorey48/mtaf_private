Feature: As a user I want to use and manage my contact lists
  ...
  Scenario: I want to see my Groups list

  Scenario: I want to create a new Group

  Scenario: I want to add a contact to my new Group

  Scenario: I want to delete a contact from my new Group
